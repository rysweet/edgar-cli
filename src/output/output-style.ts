...
export const DEFAULT_OUTPUT_STYLES: Map<string, OutputStyle> = new Map([
  ['concise', {
    name: 'concise',
...
export class OutputStyleFormatter {
  private currentStyle: OutputStyle;
  
  constructor(style?: OutputStyle) {
    this.currentStyle = style || DEFAULT_OUTPUT_STYLES.get('concise')!;
  }

  public setStyle(style: OutputStyle): void {
    this.currentStyle = style;
  }

  public getStyle(): OutputStyle {
  ...
  public applyStyle(response: string): string {
